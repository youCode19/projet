            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="defaultAddress">Définir comme adresse par défaut</label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                    <button type="submit" name="add_address" class="btn btn-primary">Enregistrer</button>
                </div>
            </form>
        </div>
    </div>
